        ...
        <div className="bg-card rounded-xl border p-6 md:p-8">
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 border rounded-lg space-y-2">
                    ...
                    <Textarea
                      ...
                      placeholder="Ex: Gostaria de uma moto com partida elétrica, pelo menos 150cc, de preferência Honda ou Yamaha"
                      rows={4}
                    />
                  </div>
                  <div className="p-4 border rounded-lg space-y-2">
                    ...
                    <Textarea
                      ...
                      placeholder="Ex: Não pego caminhão, van, ônibus, trator, imóveis, leilão, moto Biz, etc"
                      rows={3}
                    />
                  </div>
                </div>
              ...
              {formData.trade_priority === "troca_maior" && (
                <div className="space-y-4">
                  ...
                  <div className="p-4 border rounded-lg space-y-2">
                    <Label className="text-base font-semibold">Escreva aqui o que gostaria de receber na troca</Label>
                    <Textarea value={formData.ideal_trade_description} onChange={e => setFormData(p => ({ ...p, ideal_trade_description: e.target.value }))} placeholder="Ex: Quero um caminhão mais novo, cavalo mecânico 6x4..." rows={4} />
                  </div>
                  <div className="p-4 border rounded-lg space-y-2">
                    <Label className="text-base font-semibold">O que você não aceita de jeito nenhum que não adianta nem oferecerem?</Label>
              ...
              {formData.trade_priority === "chave_chave" && (
                <div className="space-y-4">
                  <div className="p-4 border rounded-lg space-y-2">
                    ...
                    <Textarea value={formData.perfect_deal_description} onChange={e => setFormData(p => ({ ...p, perfect_deal_description: e.target.value }))} placeholder="Ex: Scania R450 2020, automático, até 500.000 km, sem leilão..." rows={6} />
                  </div>
                  <div className="p-4 border rounded-lg space-y-2">
                    ...
                    <Textarea value={formData.negative_filters_description} onChange={e => setFormData(p => ({ ...p, negative_filters_description: e.target.value }))} placeholder="Ex: Câmbio manual, veículo de leilão, marcas chinesas, imóvel, etc" rows={4} />
                  </div>
                </div>
              )}
            </div>
          ...
          {step === 5 && (formData.vehicle_type !== "caminhao" && formData.vehicle_type !== "carreta") && (
            <div className="space-y-6">
              ...
              {/* Opção 1: Apenas venda — valor mínimo */}
              {formData.trade_priority === "apenas_venda" && (
                <div className="p-4 border rounded-lg space-y-2">
                  <Label className="text-base font-semibold">Coloque o valor mínimo que faz no veículo!</Label>
                  <Input
                    ...
                    placeholder="R$ 0,00"
                  />
                  <p className="text-xs text-muted-foreground">Valor mínimo aceito na venda</p>
                </div>
              )}

              {/* Opção 2: Aceito troca de menor valor */}
              {formData.trade_priority === "troca_menor" && (
                <div className="space-y-4">
                  <div className="p-4 border rounded-lg space-y-2">
                    <Label className="text-base font-semibold">Qual valor você deseja de volta para você?</Label>
